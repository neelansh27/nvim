...
local mappings = {
    ...
    l = {
        ...
        -- first bufnr checks if lsp is enabled in current buffer and second one ensures it applied to current buffer only
        h = { "<Cmd>lua vim.lsp.inlay_hint.enable(not vim.lsp.inlay_hint.is_enabled({bufnr = 0}), {bufnr = 0})<CR>", 'toggle inlay hints' },
